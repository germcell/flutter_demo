...
class WebSiteData {
  ...
  WebSiteData.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(WebSiteListItemData.fromJson(v));
      });
    }
    _errorCode = json['errorCode'];
    _errorMsg = json['errorMsg'];
  }
  List<WebSiteListItemData>? _data;
  num? _errorCode;
  String? _errorMsg;
WebSiteData copyWith({  List<WebSiteListItemData>? data,
  num? errorCode,
  String? errorMsg,
}) => WebSiteData(  data: data ?? _data,
  errorCode: errorCode ?? _errorCode,
  errorMsg: errorMsg ?? _errorMsg,
);
  List<WebSiteListItemData>? get data => _data;
...
class WebSiteListItemData {
  ...
  WebSiteListItemData.fromJson(dynamic json) {
  ...
  num? _order;
  num? _visible;
  WebSiteListItemData copyWith({  String? category,
  String? icon,
  num? id,
  String? link,
  String? name,
  num? order,
  num? visible,
}) => WebSiteListItemData(  category: category ?? _category,
  icon: icon ?? _icon,
  id: id ?? _id,
  link: link ?? _link,
  name: name ?? _name,
