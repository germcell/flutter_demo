class KnowledgeData {
  ...
  KnowledgeData.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(KnowledgeItemData.fromJson(v));
      });
    }
    _errorCode = json['errorCode'];
    _errorMsg = json['errorMsg'];
  }
  List<KnowledgeItemData>? _data;
  num? _errorCode;
  String? _errorMsg;
KnowledgeData copyWith({  List<KnowledgeItemData>? data,
  num? errorCode,
  String? errorMsg,
}) => KnowledgeData(  data: data ?? _data,
  errorCode: errorCode ?? _errorCode,
  errorMsg: errorMsg ?? _errorMsg,
);
  List<KnowledgeItemData>? get data => _data;
...
class KnowledgeItemData {
  ...
  KnowledgeItemData.fromJson(dynamic json) {
    if (json['articleList'] != null) {
      ...
      json['articleList'].forEach((v) {
        _articleList?.add(KnowledgeItemData.fromJson(v));
      });
    }
    _author = json['author'];
  ...
  num? _visible;
  KnowledgeItemData copyWith({  List<dynamic>? articleList,
  String? author,
  List<Children>? children,
  num? courseId,
  String? cover,
  ...
  bool? userControlSetTop,
  num? visible,
}) => KnowledgeItemData(  articleList: articleList ?? _articleList,
...
class Children {
  ...
  Children.fromJson(dynamic json) {
    ...
    if (json['children'] != null) {
      _children = [];
      json['children'].forEach((v) {
        _children?.add(KnowledgeItemData.fromJson(v));
      });
    }
    _courseId = json['courseId'];
    _cover = json['cover'];
